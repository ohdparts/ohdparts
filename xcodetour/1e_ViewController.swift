...
class _e_ViewController: UIViewController {
    ...
    @IBAction func slider(_ sender: UISlider) {
        ...
        let width_ft_calc = floor(Double(currentValue/12))
        let width_in_calc1 = Double(currentValue)/12
        
        let width_in_calc2 = round((width_in_calc1 - width_ft_calc)*12)
    ...
    @IBAction func slider1_plus(_ sender: UIButton) {
        if currentValue1 < max_height {
            ...
            if labeltext5 == "APCO 1100-18"  {
                let VL_High_MA_2 = ["","4.2332","4.2753","4.317","4.3583","4.3991","4.4397","4.4798","4.5196","4.559","4.5981","4.6369","4.6754","4.7135","4.7514","4.7889","4.8261","4.8631","4.8998","4.9362","4.9723","5.0082","5.0438","5.0792","5.1192","5.1492","5.1839","5.2183","5.2525","5.2525"]
            ...
            if labeltext5 == "APCO 1350-28"   {
                let VL_High_MA_3 = ["","4.368","4.4492","4.529","4.6074","4.6845","4.7603","4.8349","4.9084","4.9809","5.0522","5.1226","5.1921","5.2606","5.3282","5.395","5.461","5.5262","5.5906","5.6543","5.7173","5.7796","5.8412","5.9022","5.9625","6.0223","6.0815","6.1401","6.1981","6.2556","6.3126","6.3691","6.4251","6.4806","6.4806"]

                door_height_factor = round((Double((currentValue1) - 138) + 3) / 6)
                High_MA = Double(VL_High_MA_3[Int(door_height_factor)])!
                         }
            
            let width_ft_calc = floor(Double(currentValue1/12))
            let width_in_calc1 = Double(currentValue1)/12
    ...
    @IBAction func slider1(_ sender: UISlider) {
        ...
        if labeltext5 == "APCO 400-54" {
            ...
            let Hi_High_MA_1 = ["","2.1131","2.162","2.2098","2.2567","2.3025","2.3475","2.3916","2.435","2.4775","2.5194","2.5694","2.6011","2.641","2.6803","2.719","2.7572","2.7948","2.832"]
            let Hi_Rev_of_Spiral_1 = ["","0.2287","0.452","0.6705","0.8843","1.0937","1.2991","1.5006","1.6984","1.8928","2.0839","2.2719","2.4569","2.6391","2.8185","2.9954","3.1698","3.3418","3.5115"]
        ...
        if labeltext5 == "APCO 5250-54"  {
            ...
            let Hi_High_MA_2 = ["","2.7731","2.8264","2.8787","2.9301","2.9806","3.0302","3.0791","3.1272","3.1745","3.2212","3.2672","3.3125","3.3573","3.4014","3.445","3.4881","3.5306","3.5726","3.5726"]
            let Hi_Rev_of_Spiral_2 = ["","0.1739","0.3444","0.5118","0.6762","0.8377","0.9966","1.1529","1.3068","1.4583","1.6076","1.7548","1.8999","2.0431","2.1844","2.3239","2.4616","2.5977","2.7321","2.7321"]
        ...
        if labeltext5 == "APCO 5750-120"  {
            ...
            let Hi_High_MA_3 = ["","3.0186","3.0677","3.1159","3.1635","3.2103","3.2564","3.3019","3.3468","3.3911","3.4348","3.478","3.5206","3.5627","3.6044","3.6455","3.6862","3.7265","3.7663","3.8057","3.8447","3.8834","3.9216","3.9595","3.997","4.0341","4.0709","4.1074","4.1436","4.1795","4.215","4.2503","4.2852","4.3199","4.3543","4.3884","4.4223","4.4559,4.4893","4.5224","4.5553","4.5553"]
            let Hi_Rev_of_Spiral_3 = ["","0.1595","0.3164","0.4708","0.6229","0.7727","0.9204","1.066","1.2096","1.3513","1.4912","1.6294","1.7658","1.9006","2.0339","2.1656","2.2958","2.4247","2.5521","2.6782","2.803","2.9266","3.0489","3.1701","3.2901","3.409","3.5269","3.6436","3.7593","3.8741","3.9878","4.1006","4.2125","4.3235","4.4336","4.5428","4.6512","4.7587","4.8655","4.9715","5.0767","5.0767"]
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if labeltext2 == "duplex" {
            let destview1: _h_ViewController = segue.destination as! _h_ViewController
            destview1.wire_type = labeltext1
            
            let destview2: _h_ViewController = segue.destination as! _h_ViewController
            destview2.assy_type = labeltext2
            
            let destview3: _h_ViewController = segue.destination as! _h_ViewController
            destview3.Lift_Type = labeltext3
            
            let destview4: _h_ViewController = segue.destination as! _h_ViewController
            destview4.hi_lift = Double(labeltext4)!
            
            let destview5: _h_ViewController = segue.destination as! _h_ViewController
            destview5.Drum = labeltext5
            
            let destview6: _h_ViewController = segue.destination as! _h_ViewController
            destview6.Trk_Factor = Double(labeltext6)!
            
            let destview7: _h_ViewController = segue.destination as! _h_ViewController
            destview7.angle_sin = Double(labeltext7)!
            
            let destview8: _h_ViewController = segue.destination as! _h_ViewController
            destview8.height = Double(height)!
            
            let destview9: _h_ViewController = segue.destination as! _h_ViewController
            destview9.weight = Double(weight)!
            
            let destview10: _h_ViewController = segue.destination as! _h_ViewController
            destview10.width = Double(width)!
            
            let destview11: _h_ViewController = segue.destination as! _h_ViewController
            destview11.High_MA = (High_MA)
            
            let destview12: _h_ViewController = segue.destination as! _h_ViewController
            destview12.Rev_of_Spiral = (Rev_of_Spiral)
            
            let destview13: _h_ViewController = segue.destination as! _h_ViewController
            destview13.Flat_MA = (Flat_MA)
            
            let destview14: _h_ViewController = segue.destination as! _h_ViewController
            destview14.Circ_of_Flat = (Circ_of_Flat)
            
            let destview15: _h_ViewController = segue.destination as! _h_ViewController
            destview15.drum_width = (drum_width)
            
            let destview16: _h_ViewController = segue.destination as! _h_ViewController
            destview16.cable_len_rule = cable_len_rule
        }
        else{
            let destview1: _g_ViewController = segue.destination as! _g_ViewController
        destview1.wire_type = labeltext1
        
            let destview2: _g_ViewController = segue.destination as! _g_ViewController
        destview2.assy_type = labeltext2
        
            let destview3: _g_ViewController = segue.destination as! _g_ViewController
        destview3.Lift_Type = labeltext3
        
            let destview4: _g_ViewController = segue.destination as! _g_ViewController
        destview4.hi_lift = Double(labeltext4)!
        
            let destview5: _g_ViewController = segue.destination as! _g_ViewController
        destview5.Drum = labeltext5
        
            let destview6: _g_ViewController = segue.destination as! _g_ViewController
        destview6.Trk_Factor = Double(labeltext6)!
        
            let destview7: _g_ViewController = segue.destination as! _g_ViewController
        destview7.angle_sin = Double(labeltext7)!
        
            let destview8: _g_ViewController = segue.destination as! _g_ViewController
        destview8.height = Double(height)!
        
            let destview9: _g_ViewController = segue.destination as! _g_ViewController
        destview9.weight = Double(weight)!
        
            let destview10: _g_ViewController = segue.destination as! _g_ViewController
        destview10.width = Double(width)!
        
            let destview11: _g_ViewController = segue.destination as! _g_ViewController
        destview11.High_MA = (High_MA)
        
            let destview12: _g_ViewController = segue.destination as! _g_ViewController
        destview12.Rev_of_Spiral = (Rev_of_Spiral)
        
            let destview13: _g_ViewController = segue.destination as! _g_ViewController
        destview13.Flat_MA = (Flat_MA)
        
            let destview14: _g_ViewController = segue.destination as! _g_ViewController
        destview14.Circ_of_Flat = (Circ_of_Flat)
        
            let destview15: _g_ViewController = segue.destination as! _g_ViewController
        destview15.drum_width = (drum_width)
        
            let destview16: _g_ViewController = segue.destination as! _g_ViewController
        destview16.cable_len_rule = cable_len_rule
        }
    }
}
